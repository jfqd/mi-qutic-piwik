...
echo "10 * * * * if [ -f /var/www/htdocs/piwik/current/console  ]; then /usr/local/php7/bin/php /var/www/htdocs/piwik/current/console core:archive --url=https://piwik.qutic.com 1>> /var/www/htdocs/piwik/piwik-update.log 2>/dev/null; fi" >> /var/spool/cron/crontabs/www
# the end
